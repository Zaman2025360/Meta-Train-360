...
function XRTransientPointers() {
    ...
    return (_jsx(_Fragment, { children: transientPointerStates.map((state) => {
            ...
            return (_jsx(XRSpace, { space: "target-ray-space", children: _jsx(xrInputSourceStateContext.Provider, { value: state, children: _jsx(Suspense, { children: typeof ResolvedImpl === 'function' ? (_jsx(ResolvedImpl, {})) : (_jsx(DefaultXRTransientPointer, { ...ResolvedImpl })) }) }) }, objectToKey(state)));
        }) }));
}
function XRGazes() {
    ...
    return (_jsx(_Fragment, { children: gazeStates.map((state) => {
            return (_jsx(XRSpace, { space: "target-ray-space", children: _jsx(xrInputSourceStateContext.Provider, { value: state, children: _jsx(Suspense, { children: typeof Implementation === 'function' ? (_jsx(Implementation, {})) : (_jsx(DefaultXRGaze, { ...spreadable(Implementation) })) }) }) }, objectToKey(state)));
        }) }));
}
function XRScreenInputs() {
    ...
    return (_jsx(_Fragment, { children: screenInputStates.map((state) => {
            return (_jsx(XRSpace, { space: "target-ray-space", children: _jsx(xrInputSourceStateContext.Provider, { value: state, children: _jsx(Suspense, { children: typeof Implementation === 'function' ? (_jsx(Implementation, {})) : (_jsx(DefaultXRScreenInput, { ...spreadable(Implementation) })) }) }) }, objectToKey(state)));
        }) }));
}
